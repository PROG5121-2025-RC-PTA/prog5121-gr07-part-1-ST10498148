...
public class LoginSignup {
    ...
    public void createAccount() {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (true) {
                System.out.print("Enter South African cell phone number starting with country code +27 (e.g., +2765810166): ");
    ...
    // South African number must start with country code +27 followed by 6, 7, or 8 and 9 digits total
